...
//                       "Il y a au moins une methode de trop a la phase " + sPhase );
        veref.V.mesIfNot();      
        veref.V.verifAttThis( sFil, "Room", "aCurrentRoom"); 
        
        veref.V.verifMetThis( sFil, sMetRT, sMetName );
    } // testcreateRooms_3()
    ...
    public void testprocessCommand_8()
    {
        ...
        veref.V.verifMetThis( sFil, "void", "goRoom" );
        veref.V.verifMetThis( sFil, "boolean", "quit" );
        veref.V.verifMetThis( sFil, "void", "printHelp" );
