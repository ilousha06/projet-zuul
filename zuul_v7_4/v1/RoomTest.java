...
public class RoomTest
{
    ...
    public void testConstructeur_3()
    {
        ...
        veref.V.vrai( veref.V.nbCon( sCla ) <= 1 ,
        ...
        if ( veref.V.nbAtt(sCla) == 1 ) {
            ...
            veref.V.vrai( veref.V.nbAtt(sCla) == 5 ,
                "bizarre ce nb d'attributs : "+veref.V.nbAtt(sCla)+" !?" );
            veref.V.failIfNot();
            // verifier qu'on n'itnitialise pas les 4 sorties
        }
        veref.V.verifAttThis( sFil, sAttType, sAttName );
    } // testConstructeur_3()
    ...
    {
        testConstructeur_3();
        veref.V.verifMet( sCla, "getaDescription", "F" );
        ...
        if ( vNbAtt == 1 )
            veref.V.vrai( veref.V.nbMet( sCla ) <= 1 ,
                "Il y a au moins une méthode de trop à cette étape ..." );
        veref.V.mesIfNot();     
    ...
    public void testAttributs_5()
    {
        ...
        testConstructeur_3();
        // if ( veref.V.nbAtt(sCla) < 5 )
            // veref.V.error("Vous n'avez pas encore créé les 5 attributs.");
        // else {
    ...
    public void testsetExits_6()
    {
        ...
        for ( int vI=1; vI<=4; vI++ ) {
            ...
            veref.V.failIfNot(); 
            // veref.V.verifParamPNType( sFil, sMetName, "Room", vI );
        } // for
        veref.V.verifParamP1Type( sFil, sMetName, "Room" ); // à supprimer si verifParamPNType marche 
        ...
        try { // tenir compte de l'ordre de déclaration des attributs !!! pour 2019/2020
            ...
            fail( "L'attribut a" + vTab[vI] + " n'a pas été initialisé dans la méthode "
                + sMet.getName() /*+ sMet.getParameterString()*/
                + " : " + pE.getMessage() /*+ " at line " + pE.getStackTrace()[2].getLineNumber()*/ );
        } catch( final Exception pE ) {
            fail( "la méthode " + sMet.getName() /*+ sMet.getParameterString()*/
                + " génère l'exception " + pE );
        } // t/c
